    ...
    this.ngoDetailItem = {
      ...
      stats: {
        president: {
          ...
          values: this.ngoDetailItem.stats.presidentFirstName + ' ' + this.ngoDetailItem.stats.presidentLastName
        },
      ...
      location: {
        address: {
          displayName: 'Address',
          values: this.ngoDetailItem.contact.address.street + ', ' + this.ngoDetailItem.contact.address.postcode + ' ' + this.ngoDetailItem.contact.address.city + ', ' + this.ngoDetailItem.contact.address.country
        }
      },
      contact: {
        ...
        representative: {
          ...
          values: this.ngoDetailItem.contact.representative ? this.ngoDetailItem.contact.representative?.representativeFirstName + ' ' + this.ngoDetailItem.contact.representative?.representativeLastName + '\n' + this.ngoDetailItem.contact.representative?.representativeEmail : undefined
        }
      },
      rating: {
