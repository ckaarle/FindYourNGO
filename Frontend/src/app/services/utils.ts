...
export class Utils {
    ...
    static mapDataToNgoFilterOptions(ngoOverviewItem: any): NgoFilterOptions {
        ...
        return {
            ...
            hasAccreditations: {displayName: 'Accreditations', values: ngoOverviewItem.hasAccreditations, icon: 'account_balance'},
            fromCredibleDataSource: {displayName: 'Credibility', values: ngoOverviewItem.fromCredibleDataSource, icon: 'loyalty'},
